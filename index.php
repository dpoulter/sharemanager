...
//        render("quote_form.php", ["title" => "Stock Quote","symbols" => $stock_symbols]);
        ...
        render("quote_form.php", ["title" => "Stock Quote","momentum_topten"=> $momentum_topten,"value_topten"=> $value_topten,"quality_topten"=> $quality_topten,"overall_topten"=> $overall_topten]);
    }
