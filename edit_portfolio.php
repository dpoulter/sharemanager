...
<?php foreach ($positions as $position): ?>
    <tr>
		...
		<?php else:?>
			...
			<td><a href="edit.php?id=<?= $position["id"] ?>&action=edit"><i class="glyphicon glyphicon-pencil"></i></a></td>
			<td><a href="edit.php?id=<?= $position["id"] ?>&action=delete"><i class="glyphicon glyphicon-remove"></i></a></td>
		<?php endif?>
   </tr>
<?php endforeach ?>
</table>
...
<button id="btnAdd" name="btnAdd" type="submit" class="btn btn-default">Add</button>
</body>
